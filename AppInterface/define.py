...
img = Image.open('DataStorage/Icons/down-arrow-solid-24.png')
DOWN_ARROW_SOLID = ctk.CTkImage(light_image=img, dark_image=img)

img = Image.open('DataStorage/Icons/up-arrow-solid-24.png')
UP_ARROW_SOLID = ctk.CTkImage(light_image=img, dark_image=img)