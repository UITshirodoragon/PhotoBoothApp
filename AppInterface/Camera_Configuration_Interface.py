...
class Camera_Configuration_Interface(ctk.CTkFrame):
    ...
    def swap_capture_mode(self):
        if self.capture_screen.controller.gif_mode:
            ...
            self.capture_screen.capture_button.configure(command = self.capture_screen.capture_and_update_gallery)
            ...
            self.capture_screen.capture_button.configure(command = self.capture_screen.take_gif_and_update_gallery)
